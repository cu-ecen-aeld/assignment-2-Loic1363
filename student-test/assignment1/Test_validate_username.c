...
void test_validate_my_username()
{
     ...
     */
    const char *firstUSR = my_username();
    const char *secondUSR = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE (firstUSR, secondUSR, "not matching username !");
